/**
 * OrchestrationEventStore - Orchestration event persistence service and SQLite layer.
 *
...
/**
 * OrchestrationEventStore - Service and SQLite-backed layer for orchestration events.
 *
 * @example
 * ```ts
...
export class OrchestrationEventStore extends Context.Service<OrchestrationEventStore>()(
  "t3/persistence/Services/OrchestrationEventStore",
  {
    make: Effect.gen(function* () {
       ...
       */
      const readAll = (): Stream.Stream<OrchestrationEvent, OrchestrationEventStoreError> =>
