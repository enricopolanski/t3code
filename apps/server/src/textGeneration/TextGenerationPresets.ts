import { TextGenerationPolicy, type TextGenerationPolicyKind } from "./TextGenerationPolicy.ts";

export const defaultTextGenerationPolicy = new TextGenerationPolicy({
  kind: "default",
  inferRepositoryConventions: false,
});

export const conventionalCommitsTextGenerationPolicy = new TextGenerationPolicy({
...
export const repositoryConventionsTextGenerationPolicy = new TextGenerationPolicy({
