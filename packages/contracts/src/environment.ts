...
export class ExecutionEnvironmentPlatform extends Schema.Class<ExecutionEnvironmentPlatform>(
...
export class ExecutionEnvironmentCapabilities extends Schema.Class<ExecutionEnvironmentCapabilities>(
...
export class ExecutionEnvironmentDescriptor extends Schema.Class<ExecutionEnvironmentDescriptor>(
...
export class RepositoryIdentityLocator extends Schema.Class<RepositoryIdentityLocator>(
...
export class RepositoryIdentity extends Schema.Class<RepositoryIdentity>("RepositoryIdentity")({
...
export class ScopedProjectRef extends Schema.Class<ScopedProjectRef>("ScopedProjectRef")({
  environmentId: EnvironmentId,
  projectId: ProjectId,
}) {}

export class ScopedThreadRef extends Schema.Class<ScopedThreadRef>("ScopedThreadRef")({
  environmentId: EnvironmentId,
  threadId: ThreadId,
}) {}

export class ScopedThreadSessionRef extends Schema.Class<ScopedThreadSessionRef>(
